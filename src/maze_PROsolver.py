...
class ProSolver:
    def __init__(self):
        ...
        self.map_loader = MapLoader(crop_image=False)
        ...
        self.path = [Cell(r-self.path_finder.robot.row, c - self.path_finder.robot.column)
                     for r, c in raw_path]  # move rows to correct starting position
